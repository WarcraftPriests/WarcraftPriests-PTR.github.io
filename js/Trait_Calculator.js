...
function getIntValues() {
  Papa.parse("https://raw.githubusercontent.com/WarcraftPriests/bfa-shadow-priest/ptr/azerite-traits/Results_SC.csv", {
    download: true,
...
function addtraitToChart() {
  ...
  jQuery.getJSON("https://raw.githubusercontent.com/WarcraftPriests/bfa-shadow-priest/ptr/json_Charts/traits_" + talentChoice + "_" + fightChoice + ".json", function(data) {
    let chartItems = [];
    let graphData = [];
